  ...
  return (
    <div>
      ...
      <SectionWithPhoto
        ...
        description="From time to time, we offer investment opportunities (private equity & debt) to our community of investors. Interested to take part when this opportunity arrives?"
        photoPosition="left"
        textColor="black"
      />
